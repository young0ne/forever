$(document).ready(function(){
    ...
    TweenMax.set($('.in-line-top'), {css:{autoAlpha:0}});
    TweenMax.set($('.in-line-btm'), {css:{autoAlpha:0}});
    ...
    TweenMax.to($('.line-btm'), 0.8, {css:{'width': 80 + 'vw'}, delay:0.2, ease: Power3.easeInOut, onComplete:function(){
        $.each($title, function(i, d){
            ...
            TweenMax.to($('.in-line-top'), 0.3, {css:{rotation: '140deg', autoAlpha:1}, delay:0.1, ease: Power2.easeInOut});
            TweenMax.to($('.in-line-btm'), 0.3, {css:{rotation: '-140deg', autoAlpha:1}, delay:0.1, ease: Power2.easeInOut});
        });
    }})
